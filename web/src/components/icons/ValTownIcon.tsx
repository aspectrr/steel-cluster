...
export function ValTownIcon({ width = 30, height = 30, color = "var(--sand-12)" }: IconProps) {
  return (
    <svg
    ...
    >
      ...
      <g clipPath="url(#clip0_1045_835)">
        ...
        <path
          ...
          fill={color}
        />
        <path d="M99.9939 161.887H127.8V184.769H99.9939V161.887Z" fill={color} />
      </g>
      <defs>
        <clipPath id="clip0_1045_835">
          <rect width="200" height="143.86" fill="transparent" transform="translate(100 128)" />
        </clipPath>
      </defs>
    </svg>
  );
