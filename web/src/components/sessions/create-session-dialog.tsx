...
export const sessionFormSchema = z.object({
	sessionId: z
		...
		.uuid()
		.optional()
		.describe("Optional custom uuid for session"),
	userAgent: z
		.string()
		.optional()
		.describe("Custom user agent string for the browser session"),
	useProxy: z
		.boolean()
		.optional()
		.default(false)
	...
	proxyUrl: z
		...
		.url()
		.optional()
		.describe("Custom proxy url to use for the browser session"),
	solveCaptcha: z
		.boolean()
		.optional()
		.default(false)
	...
	isSelenium: z
		...
		.default(false)
		.describe(
			"Flag to enable selenium mode for the browser session (default: false)",
		),
});
				...
				<Form {...form}>
					<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
						<DialogHeader>
							...
							<DialogDescription>
								Configure options and start a new session.
							</DialogDescription>
						</DialogHeader>
						...
						<FormField
							...
							render={({ field }) => (
								<FormItem>
									<FormLabel className="text-[var(--sand-12)]">
										Session Timeout (ms)
									</FormLabel>
									<FormControl>
										<Input
									...
									<FormDescription>
										Session closes automatically after this time (default: 5
										minutes).
									</FormDescription>
									<FormMessage />
								</FormItem>
